...
try {
    ...
    if (empty($nameExist)) {
        ...
        $insertStmt = $conn->prepare("INSERT INTO `users` (`first_name`, `last_name`, `contact_number`, `email`, `username`, `password`) VALUES (:first_name, :last_name, :contact_number, :email, :username, :password)");
